...
public class AccountCreationPageTest extends AETask1Base{
    @Test
    public void accountCreationValidation() throws InterruptedException {
        ...
        aeTask1LogInSignUpPage.signUp("Olga One", "olepolofd@gmail.com");
